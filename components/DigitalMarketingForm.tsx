...
export default function DigitalMarketingForm() {
  ...
  return (
    <div className="form-container">
      <h4>Digital Marketing / Video Application</h4>
      <form id="studentForm" className="custom-form" ref={formRef} onSubmit={handleSubmit}>
        <input type="hidden" name="lead_type" value="Student_DigitalMarketing" />
        ...
        <div className="input-group">
          ...
          <input type="text" id="course" name="course" required placeholder="e.g. Mass Communication" />
        </div>
        <div className="input-group">
        ...
        <div className="input-group">
          <label htmlFor="portfolioLink">
            Portfolio or Website Link <span className="optional-tag">Optional</span>
          </label>
          <input type="url" id="portfolioLink" name="portfolio_link" placeholder="https://yourportfolio.com" />
        </div>
        <div className="input-group">
        ...
        <div className="input-group">
          ...
          <textarea
            ...
            name="experience"
            rows={3}
            placeholder="e.g. Created social media content for a local e-commerce brand, growing their Instagram following by 40% in 3 months."
          />
        </div>
